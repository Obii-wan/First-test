...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # When she hits enter, the homepage updates, and now the page lists
        ...
        ## We use a new browser session to make sure that no information of Edith's is comming through from cookies #
        ...
        self.assertRegex(francis_list_url, '/lisis/.+')
